...
<main class="flex flex-col items-center justify-center w-full h-screen  text-white font-sans p-4">
  <div class="w-full max-w-md mx-auto">
    ...
    <div
      class="scroller-container h-64 w-full border border-gray-700 rounded-lg overflow-hidden shadow-lg"
