<div id="root">
	...
	<br />
	<p>
		2022-present: Freelance Software Engineer.
	</p>
	<p id="lower">
		Developed web application and websites for various clients, including Dominos in Tbilisi, Georgia.
	</p><br />
	<p>
		2023-2024: Studio Fullstack Developer
	</p> 
	<p id="lower">
		Built websites for various clients, including a websites for a local restaurants in Tbilisi, Georgia.
	</p><br />
		<p>
		2024-2025: Backend Developer in freemoviesfull.cc
	</p>
	<p id="lower">
		Built backend for a movie streaming website, including video streaming, and database management.
	</p>
